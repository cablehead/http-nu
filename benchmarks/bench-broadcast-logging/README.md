...
> **Note:** Run benchmarks only with this branch checked out: `git checkout bench-broadcast-logging`

Baseline benchmark after switching from synchronous `Handler` trait to async `tokio::sync::broadcast` channel.
