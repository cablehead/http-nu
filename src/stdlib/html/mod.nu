...
export def HTML [...args: any]: nothing -> string { render-tag html ...$args }
export def HEAD [...args: any]: nothing -> string { render-tag head ...$args }
export def TITLE [...args: any]: nothing -> string { render-tag title ...$args }
export def BASE [attrs?: record]: nothing -> string { render-void-tag base $attrs }
export def LINK [attrs?: record]: nothing -> string { render-void-tag link $attrs }
export def META [attrs?: record]: nothing -> string { render-void-tag meta $attrs }
export def STYLE [...args: any]: nothing -> string { render-tag style ...$args }
export def BODY [...args: any]: nothing -> string { render-tag body ...$args }
export def ARTICLE [...args: any]: nothing -> string { render-tag article ...$args }
export def SECTION [...args: any]: nothing -> string { render-tag section ...$args }
export def NAV [...args: any]: nothing -> string { render-tag nav ...$args }
export def ASIDE [...args: any]: nothing -> string { render-tag aside ...$args }
export def HEADER [...args: any]: nothing -> string { render-tag header ...$args }
export def FOOTER [...args: any]: nothing -> string { render-tag footer ...$args }
export def MAIN [...args: any]: nothing -> string { render-tag main ...$args }
export def DIV [...args: any]: nothing -> string { render-tag div ...$args }
export def P [...args: any]: nothing -> string { render-tag p ...$args }
export def HR [attrs?: record]: nothing -> string { render-void-tag hr $attrs }
export def PRE [...args: any]: nothing -> string { render-tag pre ...$args }
export def BLOCKQUOTE [...args: any]: nothing -> string { render-tag blockquote ...$args }
export def OL [...args: any]: nothing -> string { render-tag ol ...$args }
export def UL [...args: any]: nothing -> string { render-tag ul ...$args }
export def LI [...args: any]: nothing -> string { render-tag li ...$args }
export def DL [...args: any]: nothing -> string { render-tag dl ...$args }
export def DT [...args: any]: nothing -> string { render-tag dt ...$args }
export def DD [...args: any]: nothing -> string { render-tag dd ...$args }
export def FIGURE [...args: any]: nothing -> string { render-tag figure ...$args }
export def FIGCAPTION [...args: any]: nothing -> string { render-tag figcaption ...$args }
export def A [...args: any]: nothing -> string { render-tag a ...$args }
export def EM [...args: any]: nothing -> string { render-tag em ...$args }
export def STRONG [...args: any]: nothing -> string { render-tag strong ...$args }
export def SMALL [...args: any]: nothing -> string { render-tag small ...$args }
export def CODE [...args: any]: nothing -> string { render-tag code ...$args }
export def SPAN [...args: any]: nothing -> string { render-tag span ...$args }
export def BR [attrs?: record]: nothing -> string { render-void-tag br $attrs }
export def WBR [attrs?: record]: nothing -> string { render-void-tag wbr $attrs }
export def IMG [attrs?: record]: nothing -> string { render-void-tag img $attrs }
export def IFRAME [...args: any]: nothing -> string { render-tag iframe ...$args }
export def EMBED [attrs?: record]: nothing -> string { render-void-tag embed $attrs }
export def VIDEO [...args: any]: nothing -> string { render-tag video ...$args }
export def AUDIO [...args: any]: nothing -> string { render-tag audio ...$args }
export def SOURCE [attrs?: record]: nothing -> string { render-void-tag source $attrs }
export def TRACK [attrs?: record]: nothing -> string { render-void-tag track $attrs }
export def CANVAS [...args: any]: nothing -> string { render-tag canvas ...$args }
export def SVG [...args: any]: nothing -> string { render-tag svg ...$args }
export def TABLE [...args: any]: nothing -> string { render-tag table ...$args }
export def CAPTION [...args: any]: nothing -> string { render-tag caption ...$args }
export def THEAD [...args: any]: nothing -> string { render-tag thead ...$args }
export def TBODY [...args: any]: nothing -> string { render-tag tbody ...$args }
export def TFOOT [...args: any]: nothing -> string { render-tag tfoot ...$args }
export def TR [...args: any]: nothing -> string { render-tag tr ...$args }
export def TH [...args: any]: nothing -> string { render-tag th ...$args }
export def TD [...args: any]: nothing -> string { render-tag td ...$args }
export def COL [attrs?: record]: nothing -> string { render-void-tag col $attrs }
export def COLGROUP [...args: any]: nothing -> string { render-tag colgroup ...$args }
export def FORM [...args: any]: nothing -> string { render-tag form ...$args }
export def LABEL [...args: any]: nothing -> string { render-tag label ...$args }
export def INPUT [attrs?: record]: nothing -> string { render-void-tag input $attrs }
export def BUTTON [...args: any]: nothing -> string { render-tag button ...$args }
export def SELECT [...args: any]: nothing -> string { render-tag select ...$args }
export def OPTION [...args: any]: nothing -> string { render-tag option ...$args }
export def TEXTAREA [...args: any]: nothing -> string { render-tag textarea ...$args }
export def FIELDSET [...args: any]: nothing -> string { render-tag fieldset ...$args }
export def LEGEND [...args: any]: nothing -> string { render-tag legend ...$args }
export def H1 [...args: any]: nothing -> string { render-tag h1 ...$args }
export def H2 [...args: any]: nothing -> string { render-tag h2 ...$args }
export def H3 [...args: any]: nothing -> string { render-tag h3 ...$args }
export def H4 [...args: any]: nothing -> string { render-tag h4 ...$args }
export def H5 [...args: any]: nothing -> string { render-tag h5 ...$args }
export def H6 [...args: any]: nothing -> string { render-tag h6 ...$args }
export def SCRIPT [...args: any]: nothing -> string { render-tag script ...$args }
export def NOSCRIPT [...args: any]: nothing -> string { render-tag noscript ...$args }
export def TEMPLATE [...args: any]: nothing -> string { render-tag template ...$args }
export def SLOT [...args: any]: nothing -> string { render-tag slot ...$args }
export def ABBR [...args: any]: nothing -> string { render-tag abbr ...$args }
export def B [...args: any]: nothing -> string { render-tag b ...$args }
export def I [...args: any]: nothing -> string { render-tag i ...$args }
export def U [...args: any]: nothing -> string { render-tag u ...$args }
export def S [...args: any]: nothing -> string { render-tag s ...$args }
export def MARK [...args: any]: nothing -> string { render-tag mark ...$args }
export def Q [...args: any]: nothing -> string { render-tag q ...$args }
export def CITE [...args: any]: nothing -> string { render-tag cite ...$args }
export def DFN [...args: any]: nothing -> string { render-tag dfn ...$args }
export def KBD [...args: any]: nothing -> string { render-tag kbd ...$args }
export def SAMP [...args: any]: nothing -> string { render-tag samp ...$args }
export def VAR [...args: any]: nothing -> string { render-tag var ...$args }
export def SUB [...args: any]: nothing -> string { render-tag sub ...$args }
export def SUP [...args: any]: nothing -> string { render-tag sup ...$args }
export def TIME [...args: any]: nothing -> string { render-tag time ...$args }
export def DATA [...args: any]: nothing -> string { render-tag data ...$args }
export def DEL [...args: any]: nothing -> string { render-tag del ...$args }
export def INS [...args: any]: nothing -> string { render-tag ins ...$args }
export def DETAILS [...args: any]: nothing -> string { render-tag details ...$args }
export def SUMMARY [...args: any]: nothing -> string { render-tag summary ...$args }
export def DIALOG [...args: any]: nothing -> string { render-tag dialog ...$args }
export def ADDRESS [...args: any]: nothing -> string { render-tag address ...$args }
export def HGROUP [...args: any]: nothing -> string { render-tag hgroup ...$args }
export def SEARCH [...args: any]: nothing -> string { render-tag search ...$args }
export def MENU [...args: any]: nothing -> string { render-tag menu ...$args }
export def AREA [attrs?: record]: nothing -> string { render-void-tag area $attrs }
export def MAP [...args: any]: nothing -> string { render-tag map ...$args }
export def PICTURE [...args: any]: nothing -> string { render-tag picture ...$args }
export def METER [...args: any]: nothing -> string { render-tag meter ...$args }
export def PROGRESS [...args: any]: nothing -> string { render-tag progress ...$args }
export def OUTPUT [...args: any]: nothing -> string { render-tag output ...$args }
export def DATALIST [...args: any]: nothing -> string { render-tag datalist ...$args }
export def OPTGROUP [...args: any]: nothing -> string { render-tag optgroup ...$args }
export def RUBY [...args: any]: nothing -> string { render-tag ruby ...$args }
export def RT [...args: any]: nothing -> string { render-tag rt ...$args }
export def RP [...args: any]: nothing -> string { render-tag rp ...$args }
export def BDI [...args: any]: nothing -> string { render-tag bdi ...$args }
export def BDO [...args: any]: nothing -> string { render-tag bdo ...$args }
